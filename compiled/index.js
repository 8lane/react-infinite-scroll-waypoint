...
var InfiniteScroll = function (_Component) {
	...
	_createClass(InfiniteScroll, [{
		...
		value: function attachScrollListener() {
			this.scrollElement = (0, _Helpers.getScrollParent)(this.scrollComponent, this.props.scrollElementName);
		...
		value: function scrollListener() {
			var _props = this.props,
			    ...
			    clickToUpdate = _props.clickToUpdate,
			    hasMore = _props.hasMore,
			    loading = _props.loading,
			    onUpdate = _props.onUpdate;

			var isVisible = (0, _Helpers.isWaypointVisible)(this.scrollElement, this.waypointNode);
		...
		value: function render() {
			...
			var _props2 = this.props,
			    ...
			    externalSpinner = _props2.externalSpinner,
			    children = _props2.children,
			    className = _props2.className,
			    clickToUpdate = _props2.clickToUpdate,
			    clickToUpdateBtnClassName = _props2.clickToUpdateBtnClassName,
			    clickToUpdateBtnLabel = _props2.clickToUpdateBtnLabel,
			    currentPage = _props2.currentPage,
			    CustomTag = _props2.componentTagName,
			    CustomWaypointTag = _props2.waypointTagName,
			    waypointClassName = _props2.waypointClassName,
			...
			return _react2.default.createElement(
				...
				children,
				!externalSpinner && loading ? _react2.default.createElement(
					'div',
					{ className: 'infinite-scroll__loader' },
					loadingSpinner
				) : null,
				!clickToUpdate && _react2.default.createElement(CustomWaypointTag, {
					ref: function ref(node) {
						_this2.waypointNode = node;
					},
					className: waypointClassName,
					style: { display: 'inline-block' }
				}),
				clickToUpdate && _react2.default.createElement(
					'button',
					{
						ref: function ref(node) {
							_this2.waypointNode = node;
...
InfiniteScroll.propTypes = {
	...
	scrollElementName: _propTypes2.default.string.isRequired,
	hasMore: _propTypes2.default.bool,
	currentPage: _propTypes2.default.number,
	className: _propTypes2.default.string,
	clickToUpdate: _propTypes2.default.bool,
	clickToUpdateBtnClassName: _propTypes2.default.string,
	clickToUpdateBtnLabel: _propTypes2.default.string,
	loading: _propTypes2.default.bool.isRequired,
	componentTagName: _propTypes2.default.string,
	waypointTagName: _propTypes2.default.string,
	waypointClassName: _propTypes2.default.string
};
